    ...
    return (
        <Text className='flex flex-row justify-between bg-[#183D3D] h-7 px-5 text-yellow-400 '>
            <div className='flex flex-row gap-7 '>
                ...
                <div className='hover:underline cursor-pointer hover:text-yellow-200'>Products</div>
            ...
            <div >{username ? (
                <div className="flex flex-row">
                    ...
                    <button className="pl-3 cursor-pointer hover:text-yellow-200 hover:underline" onClick={handleLogout}>Log Out</button>
                </div>
            ) : (
